...
Response::Response() : http_version("HTTP/1.1"), status_code(0)
{   
}
...
void Response::handleResponse(const RouteInfo& info, CgiResponse_t& cgi_output, const std::map<int, std::string> error_pages)
{
...
void Response::handleCGI(CgiResponse_t& cgi_output, const std::map<int, std::string > error_pages)
{
    std::map<std::string , std::string>::iterator it;
