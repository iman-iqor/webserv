...
{
public:
	ForbiddenException(const std::string &msg = "Forbidden")
...
{
public:
	MethodNotAllowedException(const std::string &msg = "Method Not Allowed")
...
{
public:
	LengthRequiredException(const std::string &msg = "Length Required")
...
{
public:
	PayloadTooLargeException(const std::string &msg = "Payload Too Large")
...
{
public:
	InternalServerErrorException(const std::string &msg = "Internal Server Error")
...
{
public:
	NotImplementedException(const std::string &msg = "Not Implemented")
